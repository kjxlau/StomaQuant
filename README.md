...
<br>Unlike YOLOv12, image augmentation is not build into the RF-DETR pipeline. Therefore, image augmentation must be performed separately using the python script. </br>
